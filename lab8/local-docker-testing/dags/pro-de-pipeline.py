...
def read_config_from_s3(bucket_name: str, file_key: str) -> dict:
...
config_bucket_name = 'ryannewkirk-lab8'
config_file_key = 'pro_config.toml'

PARAMS = read_config_from_s3(config_bucket_name, config_file_key)
...
def from_table_to_df(input_table_names, output_table_names):
    """
